...
package com.example.evan.projectcard.Utilities.ipfx;
...
public class Interpolation {
  ...
  private Interpolation(List<Vector> points, List<Line> lines){
    this.points = points;
    this.lines = lines;
  }
  ...
  public static Interpolation parseUrl(String url){
    ...
    if(data != null) {
      ...
      return new Interpolation(points, lines);
